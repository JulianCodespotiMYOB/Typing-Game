...
const GameSettings: React.FC<SettingsProps> = ({
  ...
  return (
    <div
      className={`flex justify-start space-x-5 px-4 py-2 rounded-lg h-full w-full bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 transition-opacity duration-300 ${
